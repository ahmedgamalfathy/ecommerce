...
class CreateOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
                ...
                'phones.*.phone' => 'required|string|max:15|unique:client_phones,phone',
                'phones.*.countryCode' => 'required|string|max:5',
                'emails' => 'required|array',
                'emails.*.email' => 'required|email|max:255|unique:client_emails,email',
                'addresses' => 'required|array',
                'addresses.*.address' => 'required|string|max:255',
                'addresses.*.streetNumber' => 'nullable|string|max:255',
